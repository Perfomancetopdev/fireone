...
dnf install -y https://download.postgresql.org/pub/repos/dnf/reporpms/EL-7-x86_64/pgdg-redhat-repo-latest.noarch.rpm;
...
rpm -Uvh -y https://download.postgresql.org/pub/repos/dnf/reporpms/EL-7-x86_64/pgdg-redhat-repo-latest.noarch.rpm
