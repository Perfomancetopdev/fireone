...
--
-- Name: seq_id_sup_list_2; Type: SEQUENCE; Schema: suppressions; Owner: admin
--
...
ALTER TABLE suppressions.seq_id_sup_list_2 OWNER TO admin;

--
-- Name: sup_list_2; Type: TABLE; Schema: suppressions; Owner: admin
--
...
ALTER TABLE suppressions.sup_list_2 OWNER TO admin;
...
--
-- Name: seq_id_sup_list_2; Type: SEQUENCE SET; Schema: suppressions; Owner: admin
--
...
--
-- Data for Name: sup_list_2; Type: TABLE DATA; Schema: suppressions; Owner: admin
--
...
--
-- Name: sup_list_2 c_pk_id_sup_list_2; Type: CONSTRAINT; Schema: suppressions; Owner: admin
--
...
--
-- Name: sup_list_2_idx; Type: INDEX; Schema: suppressions; Owner: admin
--
